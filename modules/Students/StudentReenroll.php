...
if(clean_param($_REQUEST['modfunc'],PARAM_ALPHA)=='save')
{
    ...
    if($_REQUEST['student'])
    {
        ...
        {
            DBQuery("INSERT INTO student_enrollment (SYEAR,SCHOOL_ID,STUDENT_ID,GRADE_ID,START_DATE,ENROLLMENT_CODE,NEXT_SCHOOL,CALENDAR_ID) VALUES ('".UserSyear()."','".UserSchool()."','$student_id','".$_REQUEST['grade_id']."','$start_date','".$_REQUEST['en_code']."','0','".$_REQUEST['cal_id']."')");
        }
